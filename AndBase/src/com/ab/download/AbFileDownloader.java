...
public class AbFileDownloader {
	...
	public AbFileDownloader(Context context,DownFile downFile,int threadNum) {
		try {
			...
			saveFile = new File(Environment.getExternalStorageDirectory().getPath()+File.separator+AbFileUtil.getDownPathFileDir()+downFile.getName());
